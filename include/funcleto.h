/*  $Id: funcleto.h,v 1.5 2008/06/01 18:35:23 ptsarenko Exp $  */
...
#define HB_SENDRECV_BUFFER_SIZE         65536
...
extern long lfc_Date( void );
extern int lfc_n2b( unsigned char *s, unsigned long int n );
extern long int lfc_b2n( unsigned char *s, int iLenLen );
extern BYTE * lfc_AddLen( BYTE * pData, ULONG * uiLen, BOOL lBefore );
extern int lfc_BagCheck( BYTE * szTable, BYTE * szBagName );
extern void writelog( char* s, int n );
extern void lfc_fileInfo( char * szFile );
extern LONG lfc_filesize( void );
extern LONG lfc_filedate( void );
extern LONG lfc_filetime( void );
