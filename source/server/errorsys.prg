/*  $Id: errorsys.prg,v 1.2 2008/02/10 14:33:28 alkresin Exp $  */
/*
...
LOCAL i
   ...
   DO WHILE ( !Empty(ProcName(i)) )
      WrLog( "Called from " + Trim(ProcName(i)) + ;
                   "(" + LTRIM(Str(ProcLine(i))) + ")  ",,.F. )
      i++
   ENDDO
...
Memvar oApp
  ...
  Fseek(nHand, 0,2 )
  Fwrite( nHand, Iif(lDateTime,Dtoc(Date())+" "+Time()+": ","") + cText + Chr(13) + Chr(10) )
  Fclose( nHand )
